        ...
        <div class="widget-box">
            <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
                ...
                <div class="serach-par">
                    ...
                    <input class="search input" name ="query" type="search" placeholder="Search Here...">
                    <button type ="submit" class="btn btn-warning newsletter-btn"><i class="fa fa-envelope"></i> Subscribe</button>
                    </form>
                </div>
            </div>
            </div>
