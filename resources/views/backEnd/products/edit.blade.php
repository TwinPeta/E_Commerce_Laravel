                ...
                <form action="{{route('product.update',$edit_product->id)}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('price')?' has-error':''}}">
                            <div class="input-prepend"> <span class="add-on">UGX</span>
                    ...
                    <div class="control-group">
                        <label for="discountprice" class="control-label">DiscountPrice</label>
                        <div class="controls{{$errors->has('discountprice')?' has-error':''}}">
                            <div class="input-prepend"> <span class="add-on">UGX</span>
                                <input type="number" name="discountprice" id="discountprice" class="" value="{{$edit_product->discountprice}}" title="" required="required">
