					...
					<form action="{{ route('add.to.cart', $detail_product->id) }}" method="get">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#">Code ID: {{$detail_product->p_code}} Review(s) | Add your review</a>
							</div>
							<div>
								<h3 class="product-price">UGX {{$detail_product->price}}<del class="product-old-price">UGX {{$detail_product->discountprice}}</del></h3>
								@if($totalStock>0)
							...
							<ul class="product-links">
								<li>Refund:</li>
								<img src="{{asset('./img/demo/refund.jpg')}}" alt="">
								<!-- <li><a href="#">Accessories</a></li> -->
							</ul>
