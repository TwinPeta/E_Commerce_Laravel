...
@include('frontEnd.layouts.header')
  ...
  <!-- end top nav bar -->
   ...
   <!-- Contact Start -->
   <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary ">Sign Up</span></h2>
        <div class="row px-xl-5">
               ...
               @endif
                    ...
                    <form   action="{{url('/register_user')}}" method="post">
                       ...
                       <div class="form-group">
                        ...
                        <h6 class="text-capitalize mt-4 mb-3">Already have an Account? <a class="text-blue" href="{{url('/login_page')}}">Signin</a></h6>
                    <!-- <div class="d-flex">
